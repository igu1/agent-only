from api.routes.shared.channel_adapters import TelegramAdapter, WhatsAppAdapter, InstagramAdapter, WebChatAdapter
...
registry.register('webchat', WebChatAdapter())
